 ...
 *
 * File Name           :         CO_LenConstdef.h
 *
 * Description         :         Contains Structure Length Constants for all
 *                               Masters.
 *
 *
 ...
 * 26/12/2005  1.4         Sonali            New File             HDFCMT_013
 * 26/12/2005  1.5         Sonali            New File             HDFCMT_016
 * 10/01/2006  1.6			Pradeep   		 New File	 		  HDFCMT_017
 * 30/12/2006  1.7       Kouser Begum        New File             HDFCMT_010                             
 * 26/12/2005  1.8       Kouser Begum        New file             HDFCMT_011
 * 06/01/2006  1.9       Pradeep             New file			  HDFCMT_004
 * 20/01/2006  1.10       Smita Bhat		   Added Length Consts  HDFCCA_027
 *											 				Related to Event 
 *	06/02/2006  1.11       Sundar             Added Length Consts  HDFCMT_GFU
 *	21/02/2006   1.14    Kouser Begum      New Maintenance  KB_001
 *  02/03/2006  1.15     Vaibhav            CA_NIS_ALLOTMENT      HDFCCA_015
 *********************************************************************/
...
#define MT_DEPO_NAME_LEN 136 /* Depo Participant Name in Depo Participant Master - by Gouse */
...
#define CA_BILAV_ID_LEN 11		/* Added by Arunachalam for CS0074500 - New Bilav File upload changes */
/*Smita - Added Event Constants - HDFCCA_027* comment/
...
/*CHITRLEKHA Client Additional Details*/
/*PANITH CSGL STARTS*/
#define MT_LEI_NUMBER 21
#define MT_CKYC_NUMBER 15
/*PANITH CSGL ENDS*/
/* Kouser - KB_001 - Client Additional Details */
...
/* Add by Gouse 20/10/2011 for Single Prematch */
#define DL_INTERDP_FLG_LEN 2
...
#define DL_VERIFIED_WITH_LEN 26
#define DL_INFO1_LEN 261
#define DL_ISPARTIAL_LEN 2
#define DL_PM_BROKER_CD_LEN 13
#define DL_BRK_CMBP_ID_LEN 21
#define DL_BRK_DP_ID_LEN 21
#define DL_MON_SETT_FLG_LEN 2
#define DL_SEC_SETT_FLG_LEN 2
/* Gouse - Single Prematch [End] */
/*added shyam for rbi monitory*/
#define MT_DEF_CLN_TYPE_LEN 11
