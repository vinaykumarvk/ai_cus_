...
typedef struct {
	...
	char h_lr_instrdate[APL_DATE_LEN];
...
typedef struct {
	...
	char p_instrdate[APL_DATE_LEN];
	char p_moneydate[APL_DATE_LEN];
	char p_instr_code[APL_INSTRUMENTCODE_LEN];
...
typedef struct {
  ...
  char p_instrconv_ind[APL_FLAG_LENGTH];
