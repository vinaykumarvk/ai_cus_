 ...
 *                                       connect funtion wit
 *                                       h the database ind.
 * 04/04/2022  1.2         kotubabu      Linux Migration     Kotak Implementation
 *********************************************************************/
...
/*#define OS_SUN  Commented by kotubabu for Linux Migration*/
#define OS_LINUX  /*added by kotubabu for Linux Migration*/


#define  APL_EMU_CCYCODE				"EUR"
#define  APL_GRD_CCYCODE				"GRD"
#define	APL_ORA_MSG_LENGTH			100
...
typedef struct {
	 ...
	 char report_header[1000];  
	 char header_query1[4001];  
	 char header_query2[4001];  
	 char header_query3[4001];  
	 char header_data1[2001];   
	 char header_data2[2001];   
	 int  no_of_tables;
	 char mst_sub_query1[4001]; 
	 char mst_sub_query2[4001]; 
	 char default_query1[4001]; 
	 char default_query2[4001]; 
	 char default_query3[4001]; 
	 char default_query4[4001]; 
	 char default_query5[4001]; 
	 char page_footer[2001];    
	 char disclaimer[4001];    

} LOGICAL_MAIN_STRUCT_H;
...
typedef struct {
	 ...
	 short header_data2;   
	 short  no_of_tables;
	 short mst_sub_query1; 
	 short mst_sub_query2; 
	 short default_query1; 
	 short default_query2; 
	 short default_query3; 
	 short default_query4; 
	 short default_query5; 
	 short page_footer;    
	 short disclaimer;    

} LOGICAL_MAIN_STRUCT_I;
...
typedef struct {
	 ...
	 int  table_id;              
	 char table_hdr[2001];             
	 char multiple_col_flag[3];     
	 char multiple_col_header[4001];   
	 char multiple_colspan_sep[2001];  
	 int  no_of_columns;         
	 char format_col_pos[501];        
	 char group_query1[4001];          
	 char group_query2[4001];          
	 char group_query3[4001];          
	 char group_query4[4001];          
	 char group_query5[4001];          
	 ...
	 char table_query6[4001];          
	 char table_query7[4001];          
	 char table_query8[4001];          
	 char table_query9[4001];          
	 char table_query10[4001];         
	 char comx_criteria_query1[4001];  
	 char comx_criteria_query2[4001];  
	 char comx_criteria_query3[4001];  
	 char comx_criteria_query4[4001];  
	 char comx_criteria_query5[4001];  
	 char comx_criteria_label[4001];   
	 char comx_criteria_pos[101];     
	 char complex_criteria1[4001];     
	 char complex_criteria2[4001];     
	 char footer_query1[4001];         
	 char footer_query2[4001];         
	 char footer_query3[4001];         
	 char footer_data1[2001];          
	 char footer_data2[2001];          
	 char record_count_query1[4001];   
	 char record_count_query2[4001];   
	 char record_count_query3[4001];   
	 char record_count_query4[4001];   
	 char record_count_query5[4001];   
	 char table_footer[2001];			

} LOGICAL_DETAILS_STRUCT_H;
...
typedef struct {
	...
	short  comx_criteria_query2;  
	short  comx_criteria_query3;  
	short  comx_criteria_query4;  
	short  comx_criteria_query5;  
	short  comx_criteria_label;   
	short  comx_criteria_pos;     
	short  complex_criteria1;     
	short  complex_criteria2;     
	short  footer_query1;         
	short  footer_query2;         
	short  footer_query3;         
	short  footer_data1;          
	...
	short  record_count_query2;   
	short  record_count_query3;   
	short  record_count_query4;   
	short  record_count_query5;   
	short  table_footer;		

} LOGICAL_DETAILS_STRUCT_I;
