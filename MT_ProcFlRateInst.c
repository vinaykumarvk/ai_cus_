...
int MT_ModFlRateInst(MT_FLRATEINST_STRUCT_H *p_mt_flrateinst_struct_h,INTL_ENV_DATA_STRUCT_H *p_intl_env_data_struct_h,DEBUG_INFO_STRUCT_H **l_debug_info_ptr)
{
...
/*	if (p_mt_flrateinst_struct_h->h_floor_rate == 0) 
	{
		APL_DATA_MISSING("Floor Rate Cannot be 0",APL_NULL_STRING,APL_NULL_STRING);
		int_error_flag = APL_FAILURE;
	}
	if (p_mt_flrateinst_struct_h->h_cap_rate== 0) 
	{
		APL_DATA_MISSING("Cap Rate Limit Cannot be 0",APL_NULL_STRING,APL_NULL_STRING);
		int_error_flag = APL_FAILURE;
	}
	if (p_mt_flrateinst_struct_h->h_base_margin == 0) 
	{
		APL_DATA_MISSING("Base Margin Cannot be 0",APL_NULL_STRING,APL_NULL_STRING);
		int_error_flag = APL_FAILURE;
	}*/
 ...
 if (strcmp(p_intl_env_data_struct_h->h_mode,APL_FUNC_INPUT))
	{
		if (!strlen(p_mt_flrateinst_struct_h->h_access_stamp)) 
		{
 ...
 if(!strcmp(p_intl_env_data_struct_h->h_mode,APL_FUNC_INPUT))
	{
		APL_IF_DEBUG
 	{
		...
		MT_ModDBFlRateInst(p_mt_flrateinst_struct_h ,p_intl_env_data_struct_h ,l_debug_info_ptr);
